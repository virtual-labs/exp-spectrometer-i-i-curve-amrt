(function () {
  ...
  function userController(
    ...
    $scope.showActionToast = function () {
      ...
      var _toast10 = $mdToast
        .simple() /** Instruction 10 */
        .content(helpArray[9])
        .action(helpArray[11])
        .hideDelay(15000)
        .highlightAction(false)
      ...
      $mdToast.show(_toast1).then(function () {
        /** Instruction 1 */ $mdToast.show(_toast2).then(function () {
          /** Instruction 2 */ $mdToast.show(_toast3).then(function () {
            /** Instruction 3 */ $mdToast.show(_toast4).then(function () {
              /** Instruction 4 */ $mdToast.show(_toast5).then(function () {
                /** Instruction 5 */ $mdToast.show(_toast6).then(function () {
                  /** Instruction 6 */ $mdToast.show(_toast7).then(function () {
                    /** Instruction 7 */ $mdToast
                      .show(_toast8)
                      .then(function () {
                        /** Instruction 8 */ $mdToast
                          .show(_toast9)
                          .then(function () {
                            /** Instruction 9 */ $mdToast
                              .show(_toast10)
                              .then(function () {
                                /** Instruction 10 */ $mdToast
                                  .show(_toast11)
                                  .then(function () {
                                    /** Instruction 11 */
                                  });
    ...
    $scope.verniertableRotate = function () {
      verniertableRotateFn(
        $scope
      ); /** Function defined in experiment.js file */
    };
    /** Function for rotating prism table  */
    $scope.prismtableRotate = function () {
      prismtableRotateFn($scope); /** Function defined in experiment.js file */
    };
    /** Function for rotating telescope - Fine adjustment */
    $scope.telescopeFineRotate = function () {
      telescopeFineRotateFn(
        $scope
      ); /** Function defined in experiment.js file */
    };
    /** Function for rotating vernier table - Fine adjustment */
    $scope.verniertableFineRotate = function () {
      verniertableFineRotateFn(
        $scope
      ); /** Function defined in experiment.js file */
    };
