...
var spectrometer_stage,
  spectrometer_container,
  prism_spectrometer_container,
  spectrometer_top_view_container;
...
var switch_on_btn_label,
  switch_off_btn_label,
  place_prism_btn_label,
  remove_prism_btn_label;
...
function directiveFunction() {
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      queue.loadManifest([
        {
          /** Spectrometer side view background */
        ...
        {
          /**  Telescope under table*/ id: "telescope_under",
          src: "././images/telescope_under.svg",
          type: createjs.LoadQueue.IMAGE,
        },
        {
          /**  Main scale  */ id: "main_scale",
          src: "././images/main_scale.svg",
          type: createjs.LoadQueue.IMAGE,
        },
        {
          /**  Prism hanger*/ id: "prism_hanger",
        ...
        {
          /**  Collimator */ id: "collimator",
          src: "././images/collimator.svg",
          type: createjs.LoadQueue.IMAGE,
        },
        {
          /**  Collimator under table*/ id: "collimator_under",
          src: "././images/collimator_under.svg",
          type: createjs.LoadQueue.IMAGE,
        },
        {
          /**  Vernier scale */ id: "vernier_scale",
          src: "././images/vernier_scale.svg",
          type: createjs.LoadQueue.IMAGE,
        },
        {
          /**  Vernier table*/ id: "vernier_table",
          src: "././images/vernier_table.svg",
          type: createjs.LoadQueue.IMAGE,
        },
        {
          /**  Vernier table*/ id: "prism_table",
          src: "././images/prism_table.svg",
          type: createjs.LoadQueue.IMAGE,
        },
        {
          /**  Light source */ id: "light",
      ...
      /** Stage creation */
      focus_telescope_container =
        new createjs.Container(); /** Focus telescope container*/
      spectrometer_stage.addChild(
        focus_telescope_container
      ); /** Add it in to the stage */
      prism_spectrometer_container =
        new createjs.Container(); /** Prism spectrometer container*/
      spectrometer_stage.addChild(
        prism_spectrometer_container
      ); /** Add it in to the stage */
      spectrometer_top_view_container =
        new createjs.Container(); /** Spectrometer top view container */
      spectrometer_stage.addChild(
        spectrometer_top_view_container
      ); /** Add it in to the stage */
      zoom_container =
      ...
      function handleComplete() {
        ...
        /** Load images */
        loadImages(
          queue.getResult("background_side_view"),
          "background_side_view",
          0,
          0,
          "",
          1,
        ...
        loadImages(
          queue.getResult("background_top_view"),
          "background_top_view",
          0,
          0,
          "",
        ...
        loadImages(
          queue.getResult("telescope_under"),
          "telescope_under",
          289,
          438,
          "",
        ...
        loadImages(
          queue.getResult("collimator_under"),
          "collimator_under",
          260,
          290,
          "",
        ...
        drawRectangle(
          ...
          "",
          zoom_container
        ); // Vernier scale 1 mask
        drawRectangle(
          vernier_scale_2_mask,
          457,
          523,
          226,
          165,
        ...
        drawDashedLine(
          slit_pointer_1,
          spectrometer_top_view_container.getChildByName("telescope").x - 160,
          spectrometer_top_view_container.getChildByName("telescope").y + 140,
          15,
          88,
          4,
          "#FFF",
        ...
        spectrometer_top_view_container.getChildByName("main_scale").rotation =
          -7.045;
        spectrometer_top_view_container.getChildByName(
          "vernier_table"
        ).rotation = 10; /** Rotate venier table */
        spectrometer_top_view_container.getChildByName(
          "vernier_scale"
        ).rotation = 10; /** Rotate venier scale */
        /** Createjs stage updation happens */
        spectrometer_stage.update();
      }
      /** Draw dashed line  */
      createjs.Graphics.prototype.dashedLineTo = function (
        x1,
        y1,
        x2,
        y2,
      ...
      function drawCircle(
        ...
        circle_name.graphics
          .beginFill("#000")
          .arc(x_pos, y_pos, circle_radius, 0, 2 * Math.PI);
      ...
      function drawRectangle(
        ...
        rect_name.graphics
          ...
          .drawRoundRect(x_rect_pos, y_rect_pos, rect_width, rect_height, 20);
      ...
      function loadImages(
        ...
        if (name == "focus_object") {
          /** Mask and blur apply on the focus object */
        ...
        if (
          ...
          /** Mask and blur apply on the slit */
        ...
        if (name == "vernier_1_scale_zoom" || name == "main_1_scale_zoom") {
          /** Mask apply on the vernier 1 zoom */
          _bitmap.mask = vernier_scale_1_mask;
        }
        if (name == "vernier_2_scale_zoom" || name == "main_2_scale_zoom") {
          /** Mask apply on the vernier 2 zoom */
        ...
        if (
          ...
          name == "prism" ||
          name == "prism_hanger" ||
          name == "main_1_scale_zoom" ||
          name == "vernier_1_scale_zoom" ||
          name == "main_2_scale_zoom" ||
          name == "vernier_2_scale_zoom"
        ) {
          // Set rotation center
          _bitmap.regX = _bitmap.image.width / 2;
          _bitmap.regY = _bitmap.image.height / 2;
      ...
      function translationLabels() {
        ...
        scope.copyright =
          _("copyright"); /** Copyright © Amrita University 2009 - 2015 */
        scope.reset = _("Reset"); /** 'Reset' button label */
        scope.start_btn_label = _("Start"); /** 'Start' button label */
        scope.telescope_focus_label = _(
          "Focusing of telescope"
        ); /** 'Focusing of telescope'  label */
        switch_on_btn_label =
          _("Switch on light"); /** 'Switch on light'  label */
        switch_off_btn_label =
          _("Switch off light"); /** 'Switch on light'  label */
        scope.switch_btn_label =
          switch_on_btn_label; /** 'Switch off light'  label */
        scope.slit_focus_label = _("Slit focus"); /** 'Slit focus'  label */
        scope.slit_width_label = _("Slit width"); /** 'Slit width'  label */
        place_prism_btn_label =
          _("Place prism"); /** 'Place prism/Remove prism' label */
        remove_prism_btn_label =
          _("Remove prism"); /** 'Remove prism'  label  */
        scope.prism_btn_label =
          place_prism_btn_label; /** 'Place prism'  label */
        scope.change_angle_label =
          _("Change angle:"); /** 'Change angle'  label */
        scope.telescope_label = _("Telescope"); /** 'Telescope'  label */
        scope.vernier_table_label =
          _("Vernier table"); /** 'Vernier table'  label */
        scope.prism_table_label = _("Prism table"); /** 'prism table'  label */
...
function telescopeMOve(scope, angle) {
  ...
  spectrometer_top_view_container.getChildByName("telescope_under").rotation =
    angle;
  spectrometer_top_view_container.getChildByName("main_scale").rotation = angle;
  tweenEndFn("telescope", angle);
  slit_center_mask.x =
    1 +
    (parseFloat(scope.telescope_model) - parseFloat(scope.vernier_model)) * 10;
  zoom_container.getChildByName("slit_center").x =
    slit_center_x + parseFloat(scope.telescope_model) * 10;
  zoom_container.getChildByName("slit_right").x =
    slit_center_x + (reflection_ac + parseFloat(scope.telescope_model)) * 10;
  zoom_container.getChildByName("slit_left").x =
    slit_center_x + (reflection_ab + parseFloat(scope.telescope_model)) * 10;
  spectrometer_stage.update();
}
...
function switchOnOrOffFn(scope) {
  ...
  scope.switch_btn_label = scope.switch_on_off
    ? switch_on_btn_label
    : switch_off_btn_label; /** Change label :- 'Switch on/off light' */
  spectrometer_top_view_container.getChildByName("light").alpha =
    scope.switch_on_off ? 0 : 1; /** 'Switch on/off light' */
...
function placePrismFn(scope) {
  scope.prism_btn_label = scope.place_prism
    ? place_prism_btn_label
    : remove_prism_btn_label; /** Change label :- 'Place/Remove prism' */
  spectrometer_top_view_container.getChildByName("prism").alpha =
    scope.place_prism ? 0 : 1; /** 'Place/Remove prism' */
  displaySlit(scope); /** Display slit */
  slitMovement(scope); /** Move the slit when the telescope rotate  */
  spectrometer_stage.update(); /** Createjs stage updation happens */
}
...
function displaySlit(scope) {
  zoom_container.getChildByName("slit_center").alpha = scope.switch_on_off
    ? 0
    : 1;
  if (scope.switch_on_off == false) {
    zoom_container.getChildByName("slit_right").alpha =
      zoom_container.getChildByName("slit_left").alpha = scope.place_prism
        ? 0
        : 1;
    zoom_container.getChildByName("slit_center").alpha = scope.place_prism
      ? 1
      : 0;
  } else {
    zoom_container.getChildByName("slit_right").alpha =
      zoom_container.getChildByName("slit_left").alpha = 0;
  }
}
...
function verniertableRotateFn(scope) {
  verniertableRotation(
    scope,
    scope.vernier_model
  ); /** Vernier table rotation */
}
/** Function :- Prism table rotation */
function prismtableRotateFn(scope) {
  prismtableRotation(scope, scope.prism_model); /** Prism table rotation */
  console.log("RotateFn: ", scope.prism_model);
}
...
function telescopeRotation(scope, angle) {
  rotationTweenEffect(
    zoom_container.getChildByName("drag_telescope"),
    angle - 45
  );
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("telescope"),
    angle
  );
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("telescope_under"),
    angle
  );
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("main_scale"),
    angle
  );
  zoomMainScaleRotation(scope);
  slitMovement(scope); /** Move the slit when the telescope rotate  */
...
function verniertableRotation(scope, angle) {
  console.log("Vernier table angle", angle);
  console.log("Prism table angle", scope.prism_model);
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("prism"),
    angle + scope.prism_model
  ); /** Rotate prism */
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("prism_hanger"),
    angle + scope.prism_model
  ); /** Rotate prism hanger*/
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("vernier_table"),
    angle
  ); /** Rotate venier table */
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("vernier_scale"),
    angle
  ); /** Rotate main scale */
  zoomMainScaleRotation(scope);
...
/** Function :- Prism  table rotation */
function prismtableRotation(scope, angle) {
  stageUpdate();
  console.log("Prism table angle", angle);
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("prism"),
    angle
  ); /** Rotate prism */
  ...
  // ); /** Rotate venier table */
  // rotationTweenEffect(
  //   spectrometer_top_view_container.getChildByName("prism_table"),
  //   angle
  // ); /** Rotate prism table */
  rotationTweenEffect(
    spectrometer_top_view_container.getChildByName("prism_hanger"),
  ...
  zoomMainScaleRotation(scope);
  reflectionCalculation(scope);
  slitMovement(scope); /** Move the slit when prism table rotate  */
}

function zoomMainScaleRotation(scope) {
  rotationTweenEffect(
    zoom_container.getChildByName("main_1_scale_zoom"),
    143 + (parseFloat(scope.telescope_model) - parseFloat(scope.vernier_model))
  ); /** Main scale rotation in zoom 1 */
  rotationTweenEffect(
    zoom_container.getChildByName("main_2_scale_zoom"),
    143 + (parseFloat(scope.telescope_model) - parseFloat(scope.vernier_model))
  ); /** Main scale rotation in zoom 2 */
}
...
function rotationTweenEffect(obj, angle) {
  createjs.Tween.get(obj)
    ...
    .call(tweenEndFn, [obj.name, angle]);
}
...
function reflectionCalculation(scope) {
  var _angle_of_prism = 60,
    _incident_angle_ab,
    _incident_angle_ac,
    _refractive_index_prism = 1.5,
    _refractive_index_surrounding = 1;
  var _radian =
    Math.PI / 180; /** To convert into radian for trignometric calculation */
  var _degree =
    180 / Math.PI; /** To convert into degree for trignometric calculation */
  /** D=i+SIN-1(SIN(A)* √(n2/n2s-SIN2(i))-COS(A)*SIN(i))-A */
  if (
    Math.abs(
      scope.vernier_model +
        scope.prism_model +
        scope.vernier_fine_model +
        _angle_of_prism / 2 -
        90
    ) > 90
  ) {
  ...
  if (
    ...
    reflection_ab =
      _incident_angle_ac +
      Math.asin(
        Math.sin(_angle_of_prism * _radian) *
          Math.pow(
            Math.pow(_refractive_index_prism, 2) /
              Math.pow(_refractive_index_surrounding, 2) -
              Math.pow(Math.sin(_incident_angle_ac * _radian), 2),
            0.5
          ) -
          Math.cos(_angle_of_prism * _radian) *
            Math.sin(_incident_angle_ac * _radian)
      ) *
        _degree -
      _angle_of_prism;
  } else {
      ...
      Math.asin(
        Math.sin(_angle_of_prism * _radian) *
          Math.pow(
            Math.pow(_refractive_index_prism, 2) /
              Math.pow(_refractive_index_surrounding, 2) -
              Math.pow(Math.sin(_incident_angle_ab * _radian), 2),
            0.5
          ) -
          Math.cos(_angle_of_prism * _radian) *
            Math.sin(_incident_angle_ab * _radian)
      ) *
        _degree -
      _angle_of_prism
    );
...
function slitMovement(scope) {
  ...
  leftDirectionTween(
    slit_center_mask,
    1 +
      (parseFloat(scope.telescope_model) -
        parseFloat(scope.vernier_model + scope.prism_model)) *
        10
  );
  leftDirectionTween(
    zoom_container.getChildByName("slit_center"),
    slit_center_x + parseFloat(scope.telescope_model) * 10
  );
  leftDirectionTween(
    zoom_container.getChildByName("slit_right"),
    slit_center_x + (reflection_ac + parseFloat(scope.telescope_model)) * 30
  );
  leftDirectionTween(
    zoom_container.getChildByName("slit_left"),
    slit_center_x + (reflection_ab + parseFloat(scope.telescope_model)) * 30
  );
}
...
function slitWidthFn(scope) {
  ...
  zoom_container.getChildByName("slit_center").scaleX =
    zoom_container.getChildByName("slit_center").scaleY = _slit_width;
  zoom_container.getChildByName("slit_left").scaleX =
    zoom_container.getChildByName("slit_left").scaleY = _slit_width;
  zoom_container.getChildByName("slit_right").scaleX =
    zoom_container.getChildByName("slit_right").scaleY = _slit_width;
  spectrometer_stage.update(); /** Createjs stage updation happens */
}
/** Function :- Apply blur  */
function applyBlurFn(obj_name, blur, container) {
  ...
  container
    .getChildByName(obj_name)
    .cache(
      0,
      0,
      container.getChildByName(obj_name).image.width,
      container.getChildByName(obj_name).image.height
    );
}
...
function drawDashedLine(
  ...
  line_name.graphics.dashedLineTo(
    move_to_x_pos,
    move_to_y_pos,
    line_to_x_pos,
    line_to_y_pos,
